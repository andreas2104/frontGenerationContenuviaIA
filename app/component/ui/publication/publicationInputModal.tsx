...
import { X as CloseIcon, Check, X as XIcon } from 'lucide-react'
import ContenuSelectionView from './contenuSelectionView'
      ...
      <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl w-full max-w-full sm:max-w-7xl max-h-[95vh] sm:max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-3 sm:p-6">
          <div className={`${isMobile ? 'flex flex-col' : 'grid grid-cols-1 lg:grid-cols-2'} gap-3 sm:gap-6 h-full`}>
            <ContenuSelectionView
              contenus={contenus}
              isLoadingContenus={isLoadingContenus}
              filterType={filterType}
              setFilterType={setFilterType}
              searchQuery={searchQuery}
              setSearchQuery={setSearchQuery}
              selectedContenu={selectedContenu}
              onSelectContenu={handleSelectContenu}
              isMobile={isMobile}
            ...
            <PublicationPreview
              ...
              publicationImmediate={publicationImmediate}
              setPublicationImmediate={setPublicationImmediate}
